...
<script language="javascript" src="../javascript/popupcalendar.js" >
</script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td width="104" class="ct_write">상품상세정보 <img
			src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"></td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><input type="text" name="prodDetail" value="${product.prodDetail}"
	...
	<tr>
		...
		<td class="ct_write01"><input type="text" readonly="readonly" name="manuDate" value="${product.manuDate}"
			class="ct_input_g" style="width: 100px; height: 19px" maxLength="10"
			minLength="6">&nbsp;<img src="../images/ct_icon_date.gif" width="15" height="15" onclick="popUpCalendar(this,manuDate,'yyyy-mm-dd')" ></img></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01"><input type="file" name="fileName"
			...
			<input type="hidden" name="REG_DATE" class="ct_input_g" 
			value="${pvo.regDate}"  ></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01"
					style="padding-top: 3px;"><a href="javascript:fncAddProduct();">수정</a></td>
