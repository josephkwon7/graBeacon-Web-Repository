...
<html>
	...
	<%-- if(user == null ||  user.isActive() != true ) {--%>
		<form  method="POST" action="/admin/logonAction">

			아  이  디 : <input type="text" name="adminId" value="${param.userId}<%--= userId --%>"><br/><br/>
			패스워드 : <input type="password" name="password" value="${param.password}<%--= password --%>"><br/><br/>
