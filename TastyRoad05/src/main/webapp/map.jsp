 ...
 <div class = "linebottom"></div>
	<header>
		<div id="header" align="center">
			<div class="wrap">
				<div class="navi-icon">
					<a href="main.html"><div class="logo"></div></a> <a
						href="intro.html"><div class="navi01"></div></a> <a
						href="map.html"><div class="navi02"></div></a> <a
						href="manage.html"><div class="navi03"></div></a>
				</div>
				<!-- 네비게이션 아이콘 -->
			</div>
			<!-- Wrap -->
	...
	<table>
		<center>
			<div id="my-box">
					...
					src="./img/design/mapex.png" width="1024" height="600"></a>
