...
kakaoUI = {},
    ...
    function (e, t) {
        ...
        if (e.firstActive > h.length - 1) return alert("�뗮똿媛� .firstActive(" + e.firstActive + ")  媛믪� " + (h.length - 1) + " �댄븯 �댁뿬�� �⑸땲��."), !1;
        ...
        case "api":
            ...
            break;
        case "voicechart":
            t.append("<li ><a href=" + e.secondlink + '><span class="location-voicechart">蹂댁씠�ㅽ넚 �꾪솴 湲곗긽��</span></a></li>');
            break;
        case "theme":
            t.append("<li ><a href=" + e.secondlink + '><span class="location-theme">�ъ슜�� �뚮쭏</span></a></li>');
            break;
        case "allchart":
            t.append("<li ><a href=" + e.secondlink + '><span class="location-voicechart">蹂댁씠�ㅽ넚 �꾪솴 湲곗긽��</span></a></li>'), t.append("<li><a href=" + e.thirdlink + '><span class="location-allchart">�꾩껜 湲곗긽��</span></a></li>')
        }
        ...
        $(".main-banner").append('<a href="' + e.link + '"><img src="' + e.src + '" alt="硫붿씤 諛곕꼫 �대�吏" /></a>')
    }, $(document).ready(function () {
    ...
    kakao.weblogin = kakao.weblogin || {}, kakao.weblogin.messages = {
            ...
            ja: {
                error: "予期しないエラーが発生しました。\nサーバーの一時的な障害またはネットワークの問題である場合があります。該当エラーはDWFチームで確認しており、対応中です。",
