...
public class JSONController {
	...
	//http://192.168.200.27:8080/tastyroad/beacon/Thumbnail/d5756247-57a2-4344-915d-9599497940a7/11/0
	@RequestMapping(value = "/Thumbnail/{uuid}/{major}/{minor}", method = RequestMethod.GET)
	public @ResponseBody
